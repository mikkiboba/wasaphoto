...
type Config struct {
	...
	// PostPath is a reference to the path of the local disk in which the posts are stored
	PostPath string
}
...
type _router struct {
	...
	// postPath is a references to where the posts are stored in the local disk
	postPath string
}
